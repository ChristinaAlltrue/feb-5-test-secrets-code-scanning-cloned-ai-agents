...
async def run_connected_agent(
    ...
    logfire.info("Starting run_connected_agent")
    ...
    try:
        ...
        user_list_sampling_analysis_agent_result = await audit_analysis_agent(
            ctx,
            report_instructions=user_list_instructions,
            software_list=software_list,
            files_to_upload=files_downloaded,
        )

        combined_result = AuditAnalysisConnectedAgentOutput(
