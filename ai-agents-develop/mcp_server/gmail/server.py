...
async def list_mails(
    ...
    For the query, you can use the following arguments:
    - is:unread : To list unread emails
    - subject:your_subject : To list emails related to specific subject
    - from:your_email@example.com : To list emails from a specific sender
    - to:your_email@example.com : To list emails to a specific recipient
    - before:2025/01/01 : To list emails before a specific date
    - after:2025/01/01 : To list emails after a specific date
    - older_than:2d : Search for emails older or newer than a time period. Use d (day), m (month), or y (year).
    - has:attachment : Search for emails with attachments

    If you have multiple queries, you must combine them with AND or OR. For example, "subject:evidence AND from:your_email@example.com".
